...
export class CalendarPage implements OnInit, AfterViewInit {
  ...
  async onSelectMonth() {
    ...
    const { SelectCalendarMonthPageModule } = await import('../select-calendar-month/select-calendar-month.module');
  ...
  async onSelectYear() {
    ...
    const { SelectCalendarYearPageModule } = await import('../select-calendar-year/select-calendar-year.module');
    const modal = await this.modalController.create({
